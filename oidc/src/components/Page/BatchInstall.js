         ...
         <Card style={{ width: '80rem', height: '40rem', display: 'flex', position: 'relative', }}>
            <Card.Body style = {{position: 'absolute', top:'50%', left:'50%', transform: 'translate(-50%, -50%)'}}>
              ...
              <>
                ...
                <div style = {{textAlign : 'center', fontWeight: 'bold', fontSize : '20px', marginBottom : '15px', width : '800px', color: 'red'}}>(+Allow out from 175.45.201.149 to 'Your IP' proto tcp port 10050)</div>
                </>
            </Card.Body>  
          </Card>
    </>
